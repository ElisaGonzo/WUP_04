...
The min of jr college is 8 and max is 12 which matches with the max of the others even though they have the lowest number of people. The HIGH SCHOOL with the highest number of attendance has the lowest min and barley makes the cut in the other categories. 
